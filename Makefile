...
publish-mahout:
	sudo docker build -q -t mpolatcan/mahout:ubuntu-0.13.0-hadoop-3.1.1 --build-arg MAHOUT_VERSION="0.13.0" --build-arg HADOOP_VERSION="3.1.1" ./ubuntu/
	sudo docker push mpolatcan/mahout:ubuntu-0.13.0-hadoop-3.1.1
	sudo docker rmi mpolatcan/mahout:ubuntu-0.13.0-hadoop-3.1.1

	sudo docker build -q -t mpolatcan/mahout:alpine-0.13.0-hadoop-3.1.1 --build-arg MAHOUT_VERSION="0.13.0" --build-arg HADOOP_VERSION="3.1.1" ./alpine/
	sudo docker push mpolatcan/mahout:alpine-0.13.0-hadoop-3.1.1
	sudo docker rmi mpolatcan/mahout:alpine-0.13.0-hadoop-3.1.1
...
# ----------------------------------------------------------------------------------------------------------------------
	...
	sudo docker build -q -t mpolatcan/mahout:ubuntu-0.12.2-hadoop-3.1.1 --build-arg MAHOUT_VERSION="0.12.2" --build-arg HADOOP_VERSION="3.1.1" ./ubuntu/
	sudo docker push mpolatcan/mahout:ubuntu-0.12.2-hadoop-3.1.1
	sudo docker rmi mpolatcan/mahout:ubuntu-0.12.2-hadoop-3.1.1

	sudo docker build -q -t mpolatcan/mahout:alpine-0.12.2-hadoop-3.1.1 --build-arg MAHOUT_VERSION="0.12.2" --build-arg HADOOP_VERSION="3.1.1" ./alpine/
	sudo docker push mpolatcan/mahout:alpine-0.12.2-hadoop-3.1.1
	sudo docker rmi mpolatcan/mahout:alpine-0.12.2-hadoop-3.1.1
